...
public class JpaConfig {
	...
	private static final String PROPERTY_NAME_DATABASE_PAWORD = "spring.datasource.password";
	...
	public DataSource dataSource() {
		...
		dataSource.setPassword(environment.getRequiredProperty(PROPERTY_NAME_DATABASE_PAWORD));
